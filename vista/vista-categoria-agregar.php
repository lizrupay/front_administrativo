  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
          ...
          $p_rptJson = $objDB->categoria_registrar($postData);


          $p_adicionarCategoria = json_decode($p_rptJson, true);

          $p_codigorpt    = $p_adicionarCategoria['mensaje_id'];
          $p_mensajerpt   = $p_adicionarCategoria['mensaje'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="agregar">
          <h1 class="agregar__titulo">Agregar Categoria</h1>
          <div class="formulario-agregar">  
            <form action="vista-agregar.php?token=<?php echo encriptar_parametro("1|2"); ?>" method="POST">
