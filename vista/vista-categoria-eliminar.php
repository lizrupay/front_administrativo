  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
              ...
              $p_rptJson = $objDB->categoria_eliminar($p_codigo);
        ...
        } else
        {
           ...
           //echo "codigo : ".$p_codigo."<br>";
            ...
            $p_rptJson = $objDB->categoria_buscar($p_codigo);



            $p_editarCategoria = json_decode($p_rptJson, true);

            $p_codigo   = $p_editarCategoria['categoria_id'];
            $p_nombre   = $p_editarCategoria['descripcion'];
            $p_estado   = $p_editarCategoria['estado'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Eliminar Categoria</h1>
          <div class="formulario-editar">  
            <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("1|2|".$p_codigo); ?>" method="POST">
            <section class="formulario-editar-grid">
              ...
              <section class="formulario-editar-boton">
                 <a href="vista-listar.php?token=<?php echo encriptar_parametro("1|2"); ?>" class="boton boton-retornar">Retornar</a>
