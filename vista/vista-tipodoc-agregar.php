  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
          ...
          $p_rptJson = $objDB->tipodoc_registrar($postData);


          $p_adicionarTipodoc = json_decode($p_rptJson, true);

          $p_codigorpt    = $p_adicionarTipodoc['mensaje_id'];
          $p_mensajerpt   = $p_adicionarTipodoc['mensaje'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="agregar">
          <h1 class="agregar__titulo">Agregar TipoDocumento</h1>
          <div class="formulario-agregar">  
            <form action="vista-agregar.php?token=<?php echo encriptar_parametro("1|4"); ?>" method="POST">
