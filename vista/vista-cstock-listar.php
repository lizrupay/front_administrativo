  ...
  <body>
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <h1 class="agregar__titulo"> CONSULTAR STOCK </h1>
          <div class="listar__buscador">
            ...
            <form action=""  method="POST">
              ...
              <select class="listar__buscador--select" name="Campo_buscar" id="Campo_buscar">
                ...
                <option value="03">Categoria</option>
                <option value="04">Subcategoria</option>
                <option value="05">Marca</option>
            ...
            <div class="contenedor-boton-crear">
              <a class="boton-crear boton" href="vista-agregar.php?token=<?php echo encriptar_parametro("3|1"); ?>"><i class="fas fa-file-export"></i>Exportar</a>
          ...
          <div class="listar__tabla">
            <table>
              <thead>
                <tr>
                  ...
                  <th class="listar__tabla--descripcion">Categoria</th>
				          <th class="listar__tabla--descripcion">Subcategoria</th>
                  <th class="listar__tabla--descripcion">Marca</th>
                  <th class="listar__tabla--descripcion">Precio</th>
				          <th class="listar__tabla--descripcion">Stock</th>
              ...
              <?php
                    ...
                    {
                          //ID
                          $p_rptJson = $objDB->producto_listar_porid($p_campo_dato);
                    }else
                    if (($p_campo_buscar =='02') && ($p_campo_dato <> ''))
                    {
                          //Descripcion
                          $p_rptJson = $objDB->producto_listar_pordescripcion($p_campo_dato);
                    }else
                    ...
                    {
                          //Descripcion
                          $p_rptJson = $objDB->producto_listar_porsubcategoria($p_campo_dato);
                    }else
                    if (($p_campo_buscar =='05') && ($p_campo_dato <> ''))
                    {
                          //Descripcion
                          $p_rptJson = $objDB->producto_listar_pormarca($p_campo_dato);
                    }else  
                    {                 
                          //all
                          $p_rptJson = $objDB->producto_listar();
                    }
              ...
              ?>
                        ...
                        <tr>
                          <td class="listar__tabla--id"><?php echo $p_itemProducto['producto_id']; ?></td>
                          <td class="listar__tabla--nombre"><?php echo $p_itemProducto['nombre']; ?></td>
                          <td class="listar__tabla--descripcion"><?php echo $p_itemProducto['nombre_categoria']; ?></td>
						  
                          <td class="listar__tabla--descripcion"><?php echo $p_itemProducto['nombre_subcategora']; ?></td>
                          <td class="listar__tabla--descripcion"><?php echo $p_itemProducto['nombre_marca']; ?></td>
                          <td class="listar__tabla--precio"><?php echo $p_itemProducto['precio']; ?></td>
                          <td class="listar__tabla--stock"><?php echo $p_itemProducto['stock']; ?></td>
                          <td class="listar__tabla--estado"><?php echo $p_itemProducto['estado']; ?></td>
                          <td class="listar__tabla--acciones">    
                            <div class="boton-aciones">
                            <a href="vista-editar.php?token=<?php echo encriptar_parametro("3|1|".$pcodigo); ?>" class="boton-aciones__editar">Visualizar</a>
                          </div> </td>
                        </tr>
