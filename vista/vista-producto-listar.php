  ...
  <body>
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <h1 class="agregar__titulo"> PRODUCTO </h1>
          <div class="listar__buscador">
            ...
            <div class="contenedor-boton-crear">
              <a class="boton-crear boton" href="vista-agregar.php?token=<?php echo encriptar_parametro("3|1"); ?>"><i class="fas fa-plus-circle"></i>Crear nuevo</a>
            </div>
          </div>
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td class="listar__tabla--acciones">    
                            ...
                            <a href="vista-editar.php?token=<?php echo encriptar_parametro("3|1|".$pcodigo); ?>" class="boton-aciones__editar">Editar</a>
                                <a href="vista-eliminar.php?token=<?php echo encriptar_parametro("3|1|".$pcodigo); ?>" class="boton-aciones__eliminar">Eliminar</a>
                          </div> </td>
                        </tr>
