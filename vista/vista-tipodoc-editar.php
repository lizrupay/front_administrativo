  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
              ...
              $p_rptJson = $objDB->tipodoc_editar($postData);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Vista editar tipo documento</h1>
          <div class="formulario-editar">  
            <form action="vista-editar.php?token=<?php echo encriptar_parametro("1|4|".$p_codigo); ?>" method="POST">
