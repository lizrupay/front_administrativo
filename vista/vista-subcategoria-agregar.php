  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
          ...
          $p_rptJson = $objDB->subcategoria_registrar($postData);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="agregar">
          <h1 class="agregar__titulo"> Agregar SubCategoria</h1>
          <div class="formulario-agregar">  
            <form action="vista-agregar.php?token=<?php echo encriptar_parametro("1|3"); ?>" method="POST">
