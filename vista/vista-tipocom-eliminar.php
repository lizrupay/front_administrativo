  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
              ...
              $p_rptJson = $objDB->tipocom_eliminar($p_codigo);


              $p_editarTipocom = json_decode($p_rptJson, true);

              $p_codigorpt    = $p_editarTipocom['mensaje_id'];
              $p_mensajerpt   = $p_editarTipocom['mensaje'];
        ...
        } else
        {
           ...
           //echo "codigo : ".$p_codigo."<br>";
            ...
            $p_rptJson = $objDB->Tipocom_buscar($p_codigo);



            $p_editarTipocom = json_decode($p_rptJson, true);

            $p_codigo   = $p_editarTipocom['tipocomprobante_id'];
            $p_nombre   = $p_editarTipocom['descripcion'];
            $p_estado   = $p_editarTipocom['estado'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Eliminar Tipo comprobante</h1>
          <div class="formulario-editar">  
            <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("1|5|".$p_codigo); ?>" method="POST">
