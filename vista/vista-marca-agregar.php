  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
          ...
          $p_rptJson = $objDB->marca_registrar($postData);


          $p_adicionarMarca = json_decode($p_rptJson, true);

          $p_codigorpt    = $p_adicionarMarca['mensaje_id'];
          $p_mensajerpt   = $p_adicionarMarca['mensaje'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="agregar">
          <h1 class="agregar__titulo">Agregar Marca</h1>
          <div class="formulario-agregar">  
            <form action="vista-agregar.php?token=<?php echo encriptar_parametro("1|1"); ?>" method="POST">
