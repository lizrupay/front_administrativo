  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
              ...
              $p_rptJson = $objDB->tipodoc_eliminar($p_codigo);


              $p_editarTipodoc = json_decode($p_rptJson, true);

              $p_codigorpt    = $p_editarTipodoc['mensaje_id'];
              $p_mensajerpt   = $p_editarTipodoc['mensaje'];
        ...
        } else
        {
           ...
           //echo "codigo : ".$p_codigo."<br>";
            ...
            $p_rptJson = $objDB->Tipodoc_buscar($p_codigo);



            $p_editarTipodoc = json_decode($p_rptJson, true);

            $p_codigo   = $p_editarTipodoc['tipodocumento_id'];
            $p_nombre   = $p_editarTipodoc['descripcion'];
            $p_estado   = $p_editarTipodoc['estado'];
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo"> Eliminar tipo documento</h1>
          <div class="formulario-editar">  
            <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("1|4|".$p_codigo); ?>" method="POST">
            ...
            <label for="codigo">
              ...
              <section class="formulario-editar-boton">
                 <a href="vista-listar.php?token=<?php echo encriptar_parametro("1|4"); ?>" class="boton boton-retornar">Retornar</a>
