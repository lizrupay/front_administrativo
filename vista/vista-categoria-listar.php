  ...
  <body>
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <h1 class="agregar__titulo"> CATEGORÍA</h1>
          <div class="listar__buscador">
            ...
            <div class="contenedor-boton-crear">
              <a class="boton-crear boton" href="vista-agregar.php?token=<?php echo encriptar_parametro("1|2"); ?>"><i class="fas fa-plus-circle"></i>Crear nuevo</a>
            </div>
          </div>
          <div class="listar__tabla">
            <table>
              ...
              <?php
                    ...
                    {
                          //ID
                          $p_rptJson = $objDB->categoria_listar_porid($p_campo_dato);
                    }else
                    if (($p_campo_buscar =='02') && ($p_campo_dato <> ''))
                    {
                          //Descripcion
                          $p_rptJson = $objDB->categoria_listar_pordescripcion($p_campo_dato);
                    }else  
                    {                 
                          //all
                    ...
                    {
                        $pcodigo = $p_itemCategoria['categoria_id'];
              ?>

                        <tr>
                          <td class="listar__tabla--id"><?php echo $p_itemCategoria['categoria_id']; ?></td>
                          <td class="listar__tabla--descripcion"><?php echo $p_itemCategoria['descripcion']; ?></td>
                          <td class="listar__tabla--estado"><?php echo $p_itemCategoria['estado']; ?></td>
                          <td class="listar__tabla--acciones">    
                            <div class="boton-aciones"><a href="vista-editar.php?token=<?php echo encriptar_parametro("1|2|".$pcodigo); ?>" class="boton-aciones__editar">Editar</a>
                            <a href="vista-eliminar.php?token=<?php echo encriptar_parametro("1|2|".$pcodigo); ?>" class="boton-aciones__eliminar">Eliminar</a>
                          </div></td>
                        </tr>
