    ...
    <?php 
        ...
        If ($pboton)
        {
             ...
             // echo json_encode($postData);
              ...
              $p_rptJson = $objDB->subcategoria_eliminar($p_codigo);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Eliminar SubCategoria</h1>
          <div class="formulario-editar">  
            <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("1|3|".$p_codigo); ?>" method="POST">
