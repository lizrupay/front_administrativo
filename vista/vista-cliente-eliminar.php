    ...
    <?php 
        ...
        If ($pboton)
        {
          ...
          $postData = array(
            ...
            $p_rptJson = $objDB->cliente_eliminar($postData);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Eliminar Cliente</h1>
          <div class="formulario-editar">  
          <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("2|2|".$p_codigo); ?>" method="POST">
