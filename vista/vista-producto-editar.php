    ...
    <?php 
        ...
        If ($pboton)
        {
             ...
             // echo json_encode($postData);
              ...
              $p_rptJson = $objDB->producto_editar($postData);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Editar Producto</h1>
          <div class="formulario-editar">  
            <form action="vista-editar.php?token=<?php echo encriptar_parametro("3|1|".$p_codigo); ?>" method="POST">
            <section class="formulario-editar-grid">
                  <label for="codigo">
                    ...
                    <label for="subcategoria">
                        ...
                        <select name="lista_subcategoria" id="lista_subcategoria" class="formulario-editar__input">
                    ...
                    <label for="marca">
                        ...
                        <select name="lista_marca" id="lista_marca" class="formulario-editar__input">
