  ...
  <body>
    ...
    <?php 
        ...
        If ($pboton)
        {
              ...
              $p_rptJson = $objDB->marca_eliminar($p_codigo);
    ...
    <main class="main">
      <div class="main__contenido">
        ...
        <section class="editar">
          <h1 class="editar__titulo">Eliminar Marca</h1>
          <div class="formulario-editar">  
            <form action="vista-eliminar.php?token=<?php echo encriptar_parametro("1|1|".$p_codigo); ?>" method="POST">
